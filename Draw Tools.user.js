...
//             saveDialogOpened= true;
		const content = `<div>
			...
			<fieldset><legend>Submission Description</legend>
			<input type='inputfield' name='PogoSaveSubmission' value='{{submission}}' id='PogoSaveSubmission'><label for='PogoSaveSubmission'><br>
			</fieldset>
		...
		const container = dialog({
			...
			buttons: {
				'Save': function () {
					const PogoSaveTitle = document.querySelector('input[name="PogoSaveTitle"]').value;
